...
const themeVariants = {
  light: {
    color: {
      ...
      toggleButtonBackground: baseTheme.color.mercury,
      toggleButtonBorder: baseTheme.color.slateGray,
      toggleButtonThumb: baseTheme.color.slateGray,
      toggleButtonIcon: baseTheme.color.white,
  ...
  dark: {
    color: {
      ...
      toggleButtonBackground: baseTheme.color.lightGray,
      toggleButtonBorder: baseTheme.color.white,
      toggleButtonThumb: baseTheme.color.white,
      toggleButtonIcon: baseTheme.color.dark,
